...
<div id="main">
    <div id="sidebar">
        <div class="panel">
            ...
            <div class="header">
                <span class="col_fade">作者个人信息</span>
            </div>
            ...
            <div class="inner">
                <div class="user_card">
                    ...
                    <div>
                        <img src='/${name.avatar}'> ${name.username}
        ...
        <div class="panel">
            ...
            <div class="inner userinfo">
                <div class="user_big_avatar">
                    <img src="/${name.avatar}" class="user_avatar" title="">
                </div>
...
<#--                            <a class="dark" href="/" target="_blank">${name} </a>-->
                        </li>
                    </ul>
                </div>

                <br>
                <p class="col_fade">注册时间是
                    <#assign datetime =name.updatedTime*1000>
